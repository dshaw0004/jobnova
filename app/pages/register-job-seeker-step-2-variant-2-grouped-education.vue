...
<template>
  <div>
    ...
    <div class="space-y-xs">
    <label class="font-label-md text-label-md text-on-surface-variant">University/College Name (UG)</label>
    <input class="w-full h-[48px] px-md bg-surface-container-low border-none rounded-lg font-body-md text-body-md focus:ring-2 focus:ring-primary-container transition-all placeholder:text-outline/60" placeholder="e.g. University of Mumbai" type="text">
    </div>
    </div>
    <!-- PG Grouped Row -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-md">
    ...
    <div class="space-y-xs">
    <label class="font-label-md text-label-md text-on-surface-variant">University/College Name (PG)</label>
    <input class="w-full h-[48px] px-md bg-surface-container-low border-none rounded-lg font-body-md text-body-md focus:ring-2 focus:ring-primary-container transition-all placeholder:text-outline/60" placeholder="e.g. University of Delhi" type="text">
    </div>
    </div>
    <!-- Location Triptych -->
    <div class="space-y-xs">
