...
<template>
  <div>
    ...
    <div class="space-y-xs">
    <label class="font-label-md text-label-md text-on-surface-variant">College / University (UG)</label>
    <input class="w-full h-[48px] px-md bg-surface-container-low border-none rounded-lg font-body-md text-body-md focus:ring-2 focus:ring-primary-container transition-all placeholder:text-outline/50" placeholder="Enter college name" type="text">
    </div>
    </div>
    <div class="space-y-lg">
    <div class="space-y-xs">
    ...
    <div class="space-y-xs">
    <label class="font-label-md text-label-md text-on-surface-variant">College / University (PG)</label>
    <input class="w-full h-[48px] px-md bg-surface-container-low border-none rounded-lg font-body-md text-body-md focus:ring-2 focus:ring-primary-container transition-all placeholder:text-outline/50" placeholder="Enter college name" type="text">
    </div>
    </div>
    </div>
