...
<template>
  <div>
    <!-- 1. Sticky Nav -->
    <nav
      class="sticky top-0 w-full z-50 bg-surface/80 backdrop-blur-md shadow-[0px_4px_20px_rgba(26,115,232,0.08)]"
    >
      <div
    ...
    <!-- 11. Footer -->
    <footer
      class="bg-surface-container-low w-full pt-xl pb-md"
    >
      <div
        class="grid grid-cols-2 md:grid-cols-5 gap-lg px-gutter max-w-7xl mx-auto mb-xl"
      >
        <div class="col-span-2 md:col-span-1">
          ...
          <p class="text-on-surface-variant text-label-md leading-relaxed">
            India's leading job platform for both Government and Private sector
            opportunities.
          </p>
        </div>
        <div>
          ...
          <ul class="space-y-4">
            <li>
              <NuxtLink
                class="text-on-surface-variant hover:text-primary transition-colors text-label-md"
                to="/"
                >About Us</NuxtLink
              >
            </li>
      ...
      <div
        class="border-t border-outline-variant px-gutter max-w-7xl mx-auto pt-md flex flex-col md:flex-row justify-between items-center gap-4"
      >
        <p class="text-on-surface-variant text-label-sm">
          © 2024 Job Nova. All rights reserved.
        </p>
        <div class="flex gap-6">
          ...
          <a
            class="text-on-surface-variant hover:text-primary transition-colors"
            href="mailto:contact@jobnova.in"
